...
var args32361 = [];
var len__24553__auto___32365 = arguments.length;
var i__24554__auto___32366 = (0);
while(true){
if((i__24554__auto___32366 < len__24553__auto___32365)){
args32361.push((arguments[i__24554__auto___32366]));

var G__32367 = (i__24554__auto___32366 + (1));
i__24554__auto___32366 = G__32367;
continue;
} else {
}
break;
...
return [cljs.core.str((function (){var strings = (function (){var G__32364 = cljs.core.keep.call(null,cljs.core.identity,replumb.common.error_seq.call(null,err));
var G__32364__$1 = (cljs.core.truth_(exclude_error_msg_QMARK_)?cljs.core.filter.call(null,((function (G__32364){
return (function (p1__32359_SHARP_){
return cljs.core.not_EQ_.call(null,"ERROR",p1__32359_SHARP_.message);
});})(G__32364))
,G__32364):G__32364);
var G__32364__$2 = cljs.core.map.call(null,((function (G__32364,G__32364__$1){
return (function (p1__32360_SHARP_){
return p1__32360_SHARP_.message;
});})(G__32364,G__32364__$1))
,G__32364__$1)
;
var G__32364__$3 = cljs.core.filter.call(null,cljs.core.complement.call(null,cljs.core.empty_QMARK_),G__32364__$2)
;
return G__32364__$3;
})();
...
var args32369 = [];
var len__24553__auto___32372 = arguments.length;
var i__24554__auto___32373 = (0);
while(true){
if((i__24554__auto___32373 < len__24553__auto___32372)){
args32369.push((arguments[i__24554__auto___32373]));

var G__32374 = (i__24554__auto___32373 + (1));
i__24554__auto___32373 = G__32374;
continue;
} else {
}
break;
...
var or__23495__auto__ = (cljs.core.not.call(null,new cljs.core.Keyword(null,"no-pr-str-on-value","no-pr-str-on-value",1045962546).cljs$core$IFn$_invoke$arity$1(opts))) && (typeof result === 'string') && (cljs.core.not.call(null,replumb.common.inline_newline_QMARK_.call(null,result)));
if(or__23495__auto__){
return or__23495__auto__;
} else {
var and__23483__auto__ = new cljs.core.Keyword(null,"no-pr-str-on-value","no-pr-str-on-value",1045962546).cljs$core$IFn$_invoke$arity$1(opts);
...
var G__32377 = new cljs.core.Keyword(null,"warning","warning",-1685650671).cljs$core$IFn$_invoke$arity$1(result);
var G__32377__$1 = (((G__32377 == null))?null:replumb.common.valid_eval_warning_QMARK_.call(null,G__32377));
return G__32377__$1;
});
/**
...
var new_fn_entries = cljs.core.map.call(null,(function (p1__32378_SHARP_){
return cljs.core.assoc.call(null,p1__32378_SHARP_,(1),"<hidden function>");
}),cljs.core.filter.call(null,(function (p1__32379_SHARP_){
return cljs.core.re_find.call(null,/-fn/,cljs.core.name.call(null,cljs.core.first.call(null,p1__32379_SHARP_)));
...
var len__24553__auto___32381 = arguments.length;
var i__24554__auto___32382 = (0);
while(true){
if((i__24554__auto___32382 < len__24553__auto___32381)){
args__24560__auto__.push((arguments[i__24554__auto___32382]));

var G__32383 = (i__24554__auto___32382 + (1));
i__24554__auto___32382 = G__32383;
continue;
} else {
}
break;
...
return replumb.common.debug_prn.cljs$core$IFn$_invoke$arity$variadic(argseq__24561__auto__);
});
...
replumb.common.debug_prn.cljs$lang$applyTo = (function (seq32380){
return replumb.common.debug_prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq32380));
});
/**
