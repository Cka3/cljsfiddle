...
var digit_29899 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_29900__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_29900__$1 > (0))){
var digit_29901__$1 = (digit_29899 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_29901__$1));

var G__29902 = (vlq_29900__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__29903 = (vlq_29900__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_29899 = G__29902;
vlq_29900__$1 = G__29903;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_29899));
}
break;
}
...
var G__29904 = i__$1;
var G__29905 = result__$1;
var G__29906 = shift__$1;
i = G__29904;
result = G__29905;
shift = G__29906;
continue;
