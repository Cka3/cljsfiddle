...
var G__30784 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__30784;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__30786 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30786,ch);
...
if(("\\" === ch__$1)){
var ch_30787__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_30787__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_30787__$2);
} else {
}

var G__30788 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__30788;
continue;
}
}
...
var args30789 = [];
var len__24553__auto___30792 = arguments.length;
var i__24554__auto___30793 = (0);
while(true){
if((i__24554__auto___30793 < len__24553__auto___30792)){
args30789.push((arguments[i__24554__auto___30793]));

var G__30794 = (i__24554__auto___30793 + (1));
i__24554__auto___30793 = G__30794;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var or__23495__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__23495__auto__){
return or__23495__auto__;
} else {
var or__23495__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var G__30802 = cljs.core.conj_BANG_.call(null,a,form);
a = G__30802;
continue;
}
}
...
var _STAR_read_delim_STAR_30804 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_30804;
}});
/**
...
var vec__30808 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30808,(0),null);
var end_column = cljs.core.nth.call(null,vec__30808,(1),null);
...
var vec__30811 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30811,(0),null);
var start_column = cljs.core.nth.call(null,vec__30811,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__30812 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30812,(0),null);
var end_column = cljs.core.nth.call(null,vec__30812,(1),null);
...
var vec__30815 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30815,(0),null);
var start_column = cljs.core.nth.call(null,vec__30815,(1),null);
...
var vec__30816 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30816,(0),null);
var end_column = cljs.core.nth.call(null,vec__30816,(1),null);
...
var sb = (function (){var G__30819 = (new goog.string.StringBuffer());
G__30819.append(initch);
...
var or__23495__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__30821 = (function (){var G__30820 = sb;
G__30820.append(ch);

return G__30820;
})();
var G__30822 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__30821;
ch = G__30822;
continue;
}
...
switch (G__30829) {
case "\\":
var G__30833 = (function (){var G__30830 = sb;
G__30830.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__30830;
})();
var G__30834 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__30833;
ch = G__30834;
continue;
...
break;
default:
var G__30835 = (function (){var G__30831 = sb;
G__30831.append(ch);

return G__30831;
})();
var G__30836 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__30835;
ch = G__30836;
continue;
...
var vec__30838 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30838,(0),null);
var end_column = cljs.core.nth.call(null,vec__30838,(1),null);
...
var vec__30841 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30841,(0),null);
var column = cljs.core.nth.call(null,vec__30841,(1),null);
...
var or__23495__auto__ = cljs.core.get.call(null,cljs.tools.reader._STAR_alias_map_STAR_,sym);
if(cljs.core.truth_(or__23495__auto__)){
return or__23495__auto__;
} else {
...
var vec__30850 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30850,(0),null);
var column = cljs.core.nth.call(null,vec__30850,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__23483__auto__ = line;
...
var vec__30859 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30859,(0),null);
var end_column = cljs.core.nth.call(null,vec__30859,(1),null);
...
var G__30861 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__30861,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_30863 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_30863;
}});
...
var G__30865 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__30865,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__30865,rdr,first_line);

return G__30865;
} else {
var or__23495__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__23495__auto__)){
return or__23495__auto__;
} else {
...
if(cljs.core.not.call(null,(function (){var and__23483__auto__ = opts;
if(cljs.core.truth_(and__23483__auto__)){
...
var _STAR_suppress_read_STAR_30873 = cljs.tools.reader._STAR_suppress_read_STAR_;
cljs.tools.reader._STAR_suppress_read_STAR_ = (function (){var or__23495__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__23495__auto__)){
return or__23495__auto__;
} else {
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_30873;
}}
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading character");
}
...
var arg_env30876 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__30877 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30877,"(");
...
var G__30878 = (i + (1));
var G__30879 = cljs.core.conj_BANG_.call(null,args,(function (){var or__23495__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__23495__auto__)){
return or__23495__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env30876;
}});
/**
...
var ch = temp__4423__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__30881 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__30881);
...
var G__30882 = cljs.core.next.call(null,s__$1);
var G__30883 = ret;
s__$1 = G__30882;
r = G__30883;
continue;
...
var G__30884 = cljs.core.next.call(null,s);
var G__30885 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__30884;
key_vals = G__30885;
continue;
} else {
...
var or__23495__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__23495__auto__)){
return or__23495__auto__;
} else {
...
if((function (){var and__23483__auto__ = ((!((form == null)))?((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || (form.cljs$core$IWithMeta$))?true:false):false);
...
))))):(cljs.core.truth_((function (){var or__23495__auto__ = (form instanceof cljs.core.Keyword);
if(or__23495__auto__){
return or__23495__auto__;
} else {
var or__23495__auto____$1 = typeof form === 'number';
if(or__23495__auto____$1){
return or__23495__auto____$1;
} else {
var or__23495__auto____$2 = typeof form === 'string';
if(or__23495__auto____$2){
return or__23495__auto____$2;
} else {
var or__23495__auto____$3 = (form == null);
if(or__23495__auto____$3){
return or__23495__auto____$3;
} else {
var or__23495__auto____$4 = cljs.tools.reader.bool_QMARK_.call(null,form);
if(cljs.core.truth_(or__23495__auto____$4)){
return or__23495__auto____$4;
} else {
...
var gensym_env30893 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env30893;
}});
...
var temp__4423__auto__ = (function (){var or__23495__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__23495__auto__)){
return or__23495__auto__;
} else {
...
var args30900 = [];
var len__24553__auto___30904 = arguments.length;
var i__24554__auto___30905 = (0);
while(true){
if((i__24554__auto___30905 < len__24553__auto___30904)){
args30900.push((arguments[i__24554__auto___30905]));

var G__30906 = (i__24554__auto___30905 + (1));
i__24554__auto___30905 = G__30906;
continue;
} else {
}
break;
...
var args30908 = [];
var len__24553__auto___30914 = arguments.length;
var i__24554__auto___30915 = (0);
while(true){
if((i__24554__auto___30915 < len__24553__auto___30914)){
args30908.push((arguments[i__24554__auto___30915]));

var G__30916 = (i__24554__auto___30915 + (1));
i__24554__auto___30915 = G__30916;
continue;
} else {
}
break;
...
var eof = cljs.core.get.call(null,map__30912__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args30918 = [];
var len__24553__auto___30921 = arguments.length;
var i__24554__auto___30922 = (0);
while(true){
if((i__24554__auto___30922 < len__24553__auto___30921)){
args30918.push((arguments[i__24554__auto___30922]));

var G__30923 = (i__24554__auto___30922 + (1));
i__24554__auto___30922 = G__30923;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__23483__auto__ = s;
if(cljs.core.truth_(and__23483__auto__)){
return !((s === ""));
} else {
return and__23483__auto__;
